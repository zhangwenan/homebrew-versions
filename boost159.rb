class Boost159 < Formula
  ...
  patch do
    url "https://raw.githubusercontent.com/Homebrew/patches/2ccb6715b3/boost/boost159-questionable-operator.patch"
  ...
  patch do
    url "https://raw.githubusercontent.com/Homebrew/patches/2ccb6715b3/boost/boost159-missing-symbols.patch"
